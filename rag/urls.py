...
from .views import AskAPIView, ChatSessionDetailAPIView, ChatSessionListAPIView, DocumentProcessingAPIView, FileUploadAPIView, LLMHealthAPIView, QuestionAnswerAPIView
...
urlpatterns = [
    ...
    path('health/llm/', LLMHealthAPIView.as_view(), name='llm-health'),
